...
class FooTest : public ::testing::Test {
 protected:
  ...
  FooTest() {
     // You can do set-up work for each gtest here.
  }
  ...
  // and cleaning up each gtest, you can define the following methods:
  ...
  void TearDown() override {
     // Code here will be called immediately after each gtest (right
     // before the destructor).
  }

  // Objects declared here can be used by all tests in the gtest suite for Foo.
};
